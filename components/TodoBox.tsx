...
const TodoBox: React.FC<TodoBoxProps> = ({
  todos, isOpen, onClose, onAddTodo, onToggleTodo, onToggleFixed, onDeleteTodo, onUpdateOrder, onMoveToTop,
            ...
            {todos.map((todo, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0">
                  {!todo.completed && (
                    <button 
                      onClick={(e) => { e.stopPropagation(); onMoveToTop(todo.id); }}
                      className="p-2 rounded-xl text-slate-300 hover:bg-slate-100 hover:text-blue-500 transition-all hover:scale-110 active:scale-95"
                      title="Move to Top"
                    >
